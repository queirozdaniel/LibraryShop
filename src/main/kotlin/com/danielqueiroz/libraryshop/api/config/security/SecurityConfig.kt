package com.danielqueiroz.libraryshop.api.config.security

import com.danielqueiroz.libraryshop.infra.security.JwtConfigurer
...
class SecurityConfig : WebSecurityConfigurerAdapter() {
    ...
    override fun configure(http: HttpSecurity) {
        http
            ...
            .and()
            .authorizeRequests()
                .antMatchers("/auth/singnin","/auth/refresh", "/api-docs/**", "/swagger-ui/index.html**").permitAll()
